...
import com.aurionpro.day13.exception.OverdraftLimitExceededException;
import com.aurionpro.day13.model.CurrentAccount;
...
//		}
		...
		// account1.setBalance(account1.debit(account1.getBalance(), 20000,
		// account1.getMinimumBalance()));
		// System.out.println(account1.getBalance());
	...
	public static void accountGenerator(Scanner scanner, int accountNumber, int minimumBalance, int overDraftLimit,
			int type) {
	...
	public static void bankOptionsForCurrent(Scanner scanner, CurrentAccount account) {
		...
		while (option != 5) {
			switch (option) {
			case 1:
				System.out.println("Your current balance is: $" + account.getBalance() + " and your draft limit is : "
			...
			case 2:
				System.out.println("Please enter amount to depoit");
				double depositAmount = scanner.nextDouble();
				double balance2 = account.credit(account, account.getBalance(), depositAmount,
						account.getOverDraftLimit(), account.getFirstLimit());
