package com.aurionpro.day23.ticTacToe1.test;
...
//		printingResults(result, result1, drawGame);
	...
	private static void internalGame(char[][] ticTacToe,int turn, Scanner scanner, boolean result, boolean result1, boolean drawGame ,boolean playerWins) {
