...
<title>AurionPro Banking - Welcome</title>
<style>
    body {
    ...
    .overlay {
        background-color: rgba(0, 0, 139, 0.5); /* Blue tint */
        position: absolute;
        top: 0;
        left: 0;
        width: 100%;
    ...
    .content {
        ...
        color: black;
        text-align: center;
        padding: 0px 40px; /* Added padding */
        margin: 20px 20px;  /* Added margin */
        background-color: rgba(255, 255, 255, 0.9);
        border-radius: 10px;
        box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);
        min-height: calc(100vh - 100px); /* Subtract the top margin */
        display: flex;
...
<body>
    ...
    <div class="navbar">
         <a href="FirstPage.jsp"><img src="aurionpros_white-2.png" alt="Logo"></a>
        <div class="nav-buttons">
            <button onclick="redirectToAdmin()">Admin Login</button>
            <button onclick="redirectToCustomer()">Customer Login</button>
        </div>
    </div>

    <div class="content">
        <h1>Welcome to AurionPro Banking Solutions</h1>
        <p>Aurionpro Solutions Limited is a technology company with a strong banking domain outlook. We aid our customers to achieve their business vision through a combination of technology products, niche services, process outsourcing, and business analytics.</p>
    </div>
