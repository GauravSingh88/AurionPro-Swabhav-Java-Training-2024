        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Senders Account Number</th>
                    <th>Receivers Account Number</th>
            ...
            <tbody>
                ...
                %>
                    <tr>
                        ...
                        <td><%= transaction.getSendersAccountNumber() %></td>
                        <td><%= transaction.getReceiversAccountNumber() %></td>
                        <td><%= transaction.getTypeOfTransfer() %></td>
    ...
    <div class="container">
     <div class="search-container">
        ...
        <div class="back-button">
            <a href="<%= request.getContextPath() %>/AdminHome.jsp">Back to Admin Home</a>
        </div>
    </div>
    <script>
        ...
        function filterTable() {
            ...
            if (filterValue === 'amountLow') {
                rows.sort((a, b) => parseFloat(a.cells[5].textContent) - parseFloat(b.cells[5].textContent));
            } else if (filterValue === 'amountHigh') {
                rows.sort((a, b) => parseFloat(b.cells[5].textContent) - parseFloat(a.cells[5].textContent));
            }
