...
<div class="form-container">
   <h2>Transaction History</h2>
        <table>
            ...
            <tbody>
                <% 
                    List<Transaction> passbooks = (List<Transaction>) request.getAttribute("passbook");
                    if (passbooks != null && !passbooks.isEmpty()) {
                        for (Transaction passbook : passbooks) { 
                %>
                    <tr>
                        <td><%= passbook.getTransactionId() %></td>
                        <td><%= passbook.getSendersAccountNumber() %></td>
                        <td><%= passbook.getReceiversAccountNumber() %></td>
                        <td><%= passbook.getTypeOfTransfer() %></td>
