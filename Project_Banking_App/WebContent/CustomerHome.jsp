...
<body>
    <div class="navbar">
        <a href="https://www.aurionpro.com/"><img src="aurionpros_white-2.png" alt="Logo"></a>
        <div class="nav-links">
            <a href="#" onclick="loadContent('ViewPassbookController')">View Passbook</a>
            <a href="#" onclick="loadContent('SendMoney.jsp')">Send Money</a>
            <a href="#" onclick="loadContent('RecieveMoney.jsp')">Recieve Money</a>
            <a href="#" onclick="loadContent('EditProfile.jsp')">Edit Profile</a>
    ...
    <div class="content">
        <div class="white-box" id="content-area">
            ...
            <p>Select an option from the menu at top to manage your account.</p>
        </div>
    </div>
